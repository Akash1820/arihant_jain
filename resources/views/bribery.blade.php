...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <a class="active" href="bribery">Bribery</a>
   ...
   <div class="col-md-10" style="background: white;"> 
    ...
    <div class="row">
        ...
        <div class="col-md-4">
               <img src="awareness\images\bribery.jfif" style="width: 100%; height: 80%; 
    ...
    <div class="row">
     ...
     <div class="col-md-5">
      <br>
       <img src="awareness\images\kidnapping\punishment.jpg" height="250" style=" width: 100%; height: 75%;  box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
     </div>
   </div>
