  ...
  <div class="dropdown-container">
   ...
   <div class="row">
     ...
     <div class="col-md-6">
      ...
      <br>
      <br>
       <img src="awareness/images\kidnapping\punishment.jpg" style=" width: 85%; height: 55%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
     </div>
   </div>
