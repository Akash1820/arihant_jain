...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <a class="active"  href="terrorist">Terrorist Financing</a>
  </div>
   ...
   <div class="col-md-10" style="background: white;"> 
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="awareness/images\terrorist.jpg" style="width: 95%; height: 71%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>
    </div>
