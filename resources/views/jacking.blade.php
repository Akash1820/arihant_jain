...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <h1 class="Display-1">Web-Jacking</h1>
    <h4>(Sec. 383 IPC)</h4>
    <hr >
    <div class="row">
        <div class="col-md-8">
            <p>Web jacking is simply when someone clones your website, and tricks you to believe the cloned site is yours. The malicious link is placed somewhere on your webpage waiting for a click. Immediately, you click on it; a malicious web server replaces it. And that means you have lost complete access to your website.</p>
            </div>
        <div class="col-md-4">
            <img src="https://cfamedia.ng/wp-content/uploads/2017/06/towards-an-understanding-of-cyber-crime-final-3-638.jpg" style=" width: 95%; height: 100%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>         
    </div>
   <div class="row">
     <div class="col-md-6">
       <h2>Punishment for Web-Jacking:</h2>
       <hr>
        <p>
  ...
  <div class="row">
    ...
    <li>Preventing web jacking might be quite cumbersome, because the internet serve sees a click as an authorized one, making it difficult to distinguish between authorized and authorized.</li>
          <li>This type of cybercrime is different from other vulnerabilities such as SQL, CSRF, XSS, injection. Web jacking is usually dependent on functionality that is widely used on the internet.</li>
    </ol>
  </div>
</div></div>
    </div></div>
