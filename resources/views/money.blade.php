...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <a class="active" href="money">Money Laundering</a>
  ...
  <div class="col-md-6">
     ...
     <img src="awareness/images\money-laundering.webp"  style="width: 100%; height:78%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
  </div>
  <div class="col-md-6">
    <p>
