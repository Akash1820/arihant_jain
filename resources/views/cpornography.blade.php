...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <h1 class="Display-1">Child Pornography</h1>
    <h4>(Sec. 292 & 293 IPC ) </h4>
    <hr >
    <div class="row">
        <div class="col-md-8">
            <p>Child pornography (also called child porn or sometimes abbreviated as CP) is pornography that exploits children for sexual stimulation.[7] It may be produced with the direct involvement or sexual assault of a child (also known as child sexual abuse images[8][9][10]) or it may be simulated child pornography. Abuse of the child occurs during the sexual acts or lascivious exhibitions of genitals or pubic areas which are recorded in the production of child pornography.[13] Child pornography may use a variety of mediums,[14] including writings,[8][15][16] magazines, photos,[14] sculpture,[14] drawing,[14] cartoon,[14] painting,[14] animation, sound recording,[17] film, video,[14] and video games.[18] Child pornography may be created for profit or other reasons.</p>
            </div>
        <div class="col-md-4">
            <img src="https://i.dailymail.co.uk/i/pix/2017/07/14/23/4258DB4900000578-4697934-image-a-2_1500069629814.jpg" style=" width: 95%; height: 75%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>         
    </div>

   <div class="row">
     <div class="col-md-6">
       <h2>Punishment for Child Pornography:</h2>
       <hr>
         <ol style="font-size:18px">
        <li>
        The ministry has also revised fines for possessing and distributing child pornography. Fine with the intent to transmit, possess porn in any form but fail to delete or destroy is at least Rs 5,000 for first offence and Rs 10,000 for repeated offenders.
         </li>
             <li>
             Fine for any person who transmits or distributes child porn except the ones producing it as evidence in court would face imprisonment of three years with fine.
             </li>
             </ol>
     </div>
     <div class="col-md-6">
      ...
      <br>
      <br>
       <img src="https://blog.ipleaders.in/wp-content/uploads/2019/07/27949750289_5fc786a346_b.jpg" style=" width: 85%; height: 75%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
     </div>
   </div>
