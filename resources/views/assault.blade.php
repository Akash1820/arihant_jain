...
<nav class="navbar navbar-expand-md  navbar-dark" style=" width: 100%; background-color: black; padding-top: 0px; padding-bottom: 0px;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link sactive" href="faq">FAQ</a>
      </li>  
      <li></li>
    </ul>
  </div> 
 ...
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="awareness\images\assault\assault.jpg" style=" width: 95%; height: 75%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>         
    </div>
<div class="row">
  <div class="col-md-12">
...
<hr>
   <div class="row">
        ...
        <div class="col-md-4">
            <img src="awareness\images\battery.jpg" style=" width: 85%; height: 75%; box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>
    </div>
<div class="row">
  <div class="col-md-12">
   ...
   <div class="row">
     ...
     <div class="col-md-6">
      ...
      <br>
      <br>
       <img src="awareness\images\kidnapping\punishment.jpg" style=" width: 85%; height: 75%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
     </div>
   </div>
