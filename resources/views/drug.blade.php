...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
   ...
   <div class="col-md-10" style="background: white;"> 
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="awareness/images\drug\drugs.jpg" style="width: 100%; height: 97%; box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>
    </div>
  ...
  <div class="col-md-6">
     ...
     <img src="awareness/images\drug\drug-manufacturing.jpeg"  style="width: 100%; height: 83%; box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
  </div>
  <div class="col-md-6">
    <p>
...
<div class="row">
  <div class="col-md-6">
   ...
   <div class="col-md-6">
    <img src="awareness/images\drug\trafficking.jpeg"  style="width: 100%; height: 83%; box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
  </div>
</div>
<h2>Drugs Dealing: </h2>
  <br>
<div class="row">
  <div class="col-md-6">
    <img src="awareness/images\drug\dealing.jpg"  style="width: 100%; height: 83%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
  </div>
  <div class="col-md-6">
    <p>
