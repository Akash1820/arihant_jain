...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <h1 class="Display-1">Defamatory Messages</h1>
    <h4>(Sec. 499 IPC) </h4>
    <hr >
    <div class="row">
        <div class="col-md-8">
            <p>Cyber defamation is publishing of defamatory material against another person with the help of computers or internet. If someone publishes some defamatory statement about some other person on a website or send emails containing defamatory material to other persons with the intention to defame the other person about whom the statement has been made would amount to cyber defamation. </p>
            </div>
        <div class="col-md-4">
...
<div class="row">
  <div class="col-md-12">
    <h2>Mediums of Defamation:</h2>
    <hr>
    <ol style="font-size:18px">
        <li>World Wide Web</li>
        <li>Discussion groups</li>
        <li>Intranets</li>
        <li>Mailing lists and bulletin boards</li>
        <li>E-mail</li>
    </ol>
  </div>
</div>
   ...
   <div class="row">
     <div class="col-md-6">
       <h2>Punishment for Defamation:</h2>
       <hr>
         <ol style="font-size:18px">
          <li>
     ...
     <div class="col-md-6">
      ...
      <br>
      <br>
       <img src="https://www.thestatesman.com/wp-content/uploads/2019/04/Defamation.jpg" style=" width: 85%; height: 75%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
     </div>
   </div>
  ...
  <div class="row">
    <div class="col-md-12">
     <ul style="font-size:18px">
         <li>Think carefully about what you’re writing.</li>
         <li>Be specific.</li>
         <li>Don’t post anything when you’re angry or emotional.</li>
         <li>If it looks like a fact, make sure it’s actually true before posting.</li>
         <li>Make it clear when a statement is opinion or joke rather than fact.</li>
         <li>Avoid making criminal allegations or associating people with terrorist/hate groups.</li>
         <li>Be cautious when writing about private citizens.</li>
         <li>Be careful when adding hashtags to the end of your tweets.</li>
         <li>Avoid modifying photos & videos in order to portray a person or business in a negative light.</li>
         <li>Avoid posting re-used clips that are taken out of context.</li>
         <li>Chose appropriate thumbnails for you online videos.</li>
         <li>Be prepared to issue a correction or apology.</li>
    </ul>
  </div>
</div></div>
</div>
