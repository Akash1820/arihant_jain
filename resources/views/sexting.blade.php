...
<div class="container-fluid" style="background-color: white;">
 <div class="row">
  ...
  <div class="dropdown-container">
    ...
    <h1 class="Display-1">Sexting</h1>
    
    <hr >
    <div class="row">
        <div class="col-md-8">
            <p>Sexting is sending, receiving, or forwarding sexually explicit messages, photographs, or images, primarily between mobile phones, of oneself to others. It may also include the use of a computer or any digital device.[1] The term was first popularized early in the 21st century and is a portmanteau of sex and texting.</p>
            </div>
        <div class="col-md-4">
            <img src="https://blog.ipleaders.in/wp-content/uploads/2017/06/BV-Acharya-101.jpg" style=" width: 95%; height: 100%;box-shadow: 4px 6px 8px 0 rgba(0, 0, 0, 0.2), 4px 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius:5%">
        </div>         
    </div>
   <div class="row">
     <div class="col-md-6">
       <h2>Punishment for Sexting:</h2>
       <hr>
        <p>
       There is no specific law against it and neither is there enough precedent. But if we look closely at Section 67 of the IT Act, 2008, it says that “if somebody publishes or transmits any material which is lascivious or appeals to the prurient interest or if its effect is such as to tend to deprave and corrupt persons who are likely, having regard to all relevant circumstances, to read, see or hear the matter contained or embodied in it, shall be punished on first conviction with imprisonment of either description for a term which may extend to three years.”
        </p>
     </div>
   </div>
  ...
  <div class="row">
    ...
    <li>To help prevent sexting, set rules for internet and cell phone use with your child. Discuss the consequences for breaking these rules. Continue to keep the lines of communication open with your child so that they are not afraid to talk about sexting with you.</li>
    </ul>
  </div>
</div>
     
     <h1>What to Do If Image is already Shared?</h1>
     <hr>
        <div class="row">
            <div class="col-md-7">
                <ol style="font-size:20px">
                <li>Report it to the website or apps where the image is posted. Make it clear your child is a minor and it was posted without consent.</li>
                    <li>Talk to school officials so they can help stop the spread of the image or any harassment that could be happening.</li>
                    <li>Contact the police if your child is being blackmailed, harassed, or if it involves an adult.</li>
                    <li>Continue to offer support. Assure them that you’ll get through this together. Consider seeking professional counseling if they need help coping.</li>
                </ol> 
            </div>
           </div>
